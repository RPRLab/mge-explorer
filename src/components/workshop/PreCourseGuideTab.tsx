...
const mgeTypes = [
  ...
  { name: "ICEs", short: "Large self-transferring elements that integrate into chromosomes.", detail: "Integrative and Conjugative Elements are large (often >50 kb) chromosomally integrated MGEs that can excise, circularize, and self-transfer by conjugation. They do not encode a capsid and transfer exclusively through a conjugative pilus. Their large size allows them to carry extensive cargo including antibiotic resistance islands, metabolic gene clusters, and defence systems. ICEs in Vibrio cholerae carry anti-phage defences (BREX, restriction-modification) that engage in ongoing evolutionary warfare with lytic phages like ICP1.", color: "bg-cyan-500/10 border-cyan-500/30 hover:border-cyan-500/60" },
